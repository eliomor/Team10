...
<h1> Registration from</h1>
	<div class="mangregister">
	<form method="post" id="mangregister" action ="login.jsp">
		 <h2>Register Here</h2>
		 <label> ID  manger:</label><br>
		 <input type="number" name="managerId" id="number"
		 placeholder="Enter your id"><br><br>
		 <label> first name manger:</label><br>
		 <input type="text" name="Fname" id="name"
		 placeholder="Enter boy first name"><br><br>
		 <label> Last  name manger:</label><br>
